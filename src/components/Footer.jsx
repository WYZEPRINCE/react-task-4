...
function Footer() {
  return (
    <div className="bg-black px-4 lg:px-30 py-8 lg:py-15">
      {/* subscribe */}
      <div className="flex flex-col lg:flex-row gap-8 w-full">
        <span className="flex flex-col gap-5">
          ...
          <div className="border-1 border-white flex justify-between text-white place-items-center px-2 py-1">
            <input type="email" name="email" id="email" placeholder="Enter your email" className="focus:outline-none" />
            <FaPaperPlane />
          </div>
        </span>
        {/* support */}
        <span className="flex flex-col gap-4">
          ...
          <p className="text-white text-sm font-normal">111 Bijoy sarani, Dhaka, DH 1515, Bangladesh.</p>
        ...
        <span className="flex flex-col gap-4">
          ...
          <p className="text-white text-sm font-normal">My Account</p>
        ...
        <span className="flex flex-col gap-4">
          ...
          <p className="text-white text-sm font-normal">Privacy Policy</p>
        ...
        <span className="flex flex-col gap-4">
          ...
          <p className="text-gray-400 text-xs font-normal">Save $3 with App New User Only</p>
